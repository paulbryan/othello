...
function isNextToEmptyCorner(row, col) {
    const corners = [
        {corner: [0, 0], adjacent: [[0, 1], [1, 0], [1, 1]]},
        {corner: [0, BOARD_SIZE - 1], adjacent: [[0, BOARD_SIZE - 2], [1, BOARD_SIZE - 1], [1, BOARD_SIZE - 2]]},
        {corner: [BOARD_SIZE - 1, 0], adjacent: [[BOARD_SIZE - 2, 0], [BOARD_SIZE - 1, 1], [BOARD_SIZE - 2, 1]]},
        {corner: [BOARD_SIZE - 1, BOARD_SIZE - 1], adjacent: [[BOARD_SIZE - 2, BOARD_SIZE - 1], [BOARD_SIZE - 1, BOARD_SIZE - 2], [BOARD_SIZE - 2, BOARD_SIZE - 2]]}
    ];
...
function updateCurrentPlayer() {
    const playerName = currentPlayer === 'black' ? 'Black' : 
                      (gameMode === 'pvc' ? 'Computer (White)' : 'White');
